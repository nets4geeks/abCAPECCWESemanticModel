...
// eats CAPEC in XML
public class CWEParser extends AbstractParser{
      ...
      for (int m = 0; m<nodelist.getLength(); m++){
          ...
          if (tmpname.equals("Description")) {
             ...
             if (tmpnode1 != null){
                ...
                log("could not read Description (ID="+ID+")");
             }
             continue;
          }
          ...
          if (tmpname.equals("Likelihood_Of_Exploit")) {
             ...
             if (tmpnode1 != null){
                ...
                log("could not read ExploitLikehood (ID="+ID+")");
             }
             continue;
          }
